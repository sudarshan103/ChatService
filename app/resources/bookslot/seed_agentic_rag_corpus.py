    ...
    return [
        {
            ...
            "provider_id": None,
            "provider_name": None,
            "service_tags": ["orthopedic", "knee_pain", "joint_pain"],
            "content": "Orthopedic treats bones, joints, muscles, ligaments, and common knee pain concerns.",
        },
        {
            "record_type": "provider_profile",
            "service_category": "Orthopedic",
            "provider_id": 3,
            "provider_name": "Dr. Nikhil Jadhav",
            "service_tags": ["orthopedic", "knee_pain", "sports_injury"],
            "content": "Dr. Nikhil Jadhav is an Orthopedic specialist available for bone, joint, and ligament issues.",
        },
        {
            "record_type": "service_summary",
            "service_category": "Cardiologist",
            "provider_id": None,
            "provider_name": None,
            "service_tags": ["cardiology", "chest_pain", "palpitations"],
        ...
        },
        {
            ...
            "service_category": "Cardiologist",
            "provider_id": 1,
            "provider_name": "Dr. Priya",
            "service_tags": ["cardiology", "heart_consult", "blood_pressure"],
        ...
        },
        {
            ...
            "provider_id": None,
            "provider_name": None,
            "service_tags": ["gastroenterology", "acidity", "abdominal_pain"],
        ...
        },
        {
            ...
            "service_category": "Gastroenterology",
            "provider_id": 2,
            "provider_name": "Dr. Sheetal",
            "service_tags": ["gastroenterology", "acidity", "digestive_health"],
            "content": "Dr. Sheetal is a Gastroenterology specialist for digestive complaints and abdominal discomfort.",
        },
    ]


def seed_knowledge_corpus(clear_seed_rows: bool = False) -> None:
    ...
    if clear_seed_rows:
        cur.execute(
            f"DELETE FROM {table_name} WHERE record_type IN ('service_summary', 'provider_profile')"
        )
    ...
    (record_type, service_category, provider_id, provider_name, service_tags, content, embedding)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Seed knowledge_corpus_vectors for agentic RAG")
    parser.add_argument(
        "--clear-seed-rows",
        action="store_true",
        help="Delete existing service_summary and provider_profile rows before inserting",
    )
    args = parser.parse_args()
    seed_knowledge_corpus(clear_seed_rows=args.clear_seed_rows)
